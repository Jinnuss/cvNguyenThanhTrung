        ...
        <>
            <div className='h-[600px] overflow-hidden'>
                <div className=''>
                    ...
                    <div className="item1-section2home left-[5%]  absolute sm:top-[48%] md:top-[55%] lg:top-[80%] w-[90%] bg-[white]">
                        ...
                        <div className="md:block lg:flex px-[10%] py-[3%] lg:justify-between mb-[100px]">
                            ...
                            <div className='flex justify-center mb-[40px]'>
                                <div className="item2-section2home-right lg:w-[100%] md:w-[100%]">
                                    <div className="flex ml-[60px] justify-between mb-[50px]">
                                    ...
                                    <div className="flex ml-[60px] justify-between">
