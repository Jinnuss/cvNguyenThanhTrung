            ...
            <div className="">
                <div className="menu p-[10px] rounded-[10px] flex justify-between">
                    <div className='w-[50px] h-[50px] lg:block'>
                        <img src={logo} alt='logo' className='object-cover rounded-[10px]' />
                    </div>
                    <div className='flex md:justify-between items-center sm:justify-center'>
                        <div className='text-[white] sm:hidden lg:block md:text-[16px] lg:text-[20px] mr-[10px] itemmenu flex items-center cursor-pointer w-[130px] hover:text-[22px] hover:font-bold'>
